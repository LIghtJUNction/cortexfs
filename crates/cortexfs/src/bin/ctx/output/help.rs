...
pub(crate) fn print_help_topic(topic: &str) -> Result<(), CliError> {
    match topic {
        ...
        "agent" => print_help_lines(&[
            ...
            "  ctx [--root PATH] agent pack NAME [--session SESSION]",
            "  ctx [--root PATH] agent trajectory NAME [--session SESSION]",
            "  ctx [--root PATH] agent session gc NAME [--dry-run] [--delete] [--yes] [--match GLOB] [--keep SESSION] [--older-than-days DAYS]",
            ...
            "",
            "session gc:",
            "  defaults to a no-write archive preview; --yes archives under the backing session root",

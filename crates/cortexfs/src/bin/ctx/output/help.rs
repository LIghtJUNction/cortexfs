...
pub(crate) fn print_help() -> Result<(), CliError> {
    print_help_lines(&[
        ...
        "  If you only want to chat, use: ctx agent chat executor",
        "",
        "defaults:",
        "  agent: executor (override with CTX_DEFAULT_AGENT)",
...
pub(crate) fn print_help_topic(topic: &str) -> Result<(), CliError> {
    match topic {
        ...
        "bootstrap" => print_help_lines(&[
            ...
            "",
            "creates:",
            "  default agents: architect, executor, product-manager",
        ...
        "resume" => print_help_lines(&[
            ...
            "  omit AGENT to use executor or CTX_DEFAULT_AGENT",
            "",
            "session:",
        ...
        "agent prompt" => print_help_lines(&[
            ...
            "  shows the bootstrap executor instructions, runtime contract, and tsh tool-call rules",
        ]),
        "agent tools" => print_help_lines(&[
            ...
            "  verifies the bootstrapped executor can see tsh, fs.read, fs.list, fs.stat, fs.write, fs.replace, and shell.exec",
        ]),

...
pub(crate) fn print_help() -> Result<(), CliError> {
    print_help_lines(&[
        ...
        "  ctx object ...     install and inspect objects",
...
pub(crate) fn print_help_topic(topic: &str) -> Result<(), CliError> {
    match topic {
        ...
        "agent" => print_help_lines(&[
            ...
            "  ctx [--root PATH] agent start NAME [--session SESSION] [--cwd PATH] [--mount SOURCE TARGET ro|rw] [--environment sandbox|native] [--ack-host-access] [--no-default-workspace]",
        ...
        "agent start" => print_help_lines(&[
            ...
            "  --environment native --ack-host-access starts a host-native bash terminal",

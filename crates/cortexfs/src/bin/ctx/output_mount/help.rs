...
fn print_help_topic(topic: &str) -> Result<(), CliError> {
    match topic {
        ...
        "agent ps" => print_help_lines(&[
            ...
            "",
            "output:",
            "  agent [status] model=MODEL life=LIFE pid=PID",
        ...
        "agent children" => print_help_lines(&[
            ...
            "",
            "output:",
            "  child<TAB>status<TAB>agent<TAB>session<TAB>model<TAB>life<TAB>agent_status<TAB>pid",
            "",
            "session:",
            "  omitting --session uses session/index/current, then default",
        ]),
        "agent wait" => print_help_lines(&[
            ...
            "",
            "output:",
            "  child<TAB>status<TAB>agent<TAB>session<TAB>model<TAB>life",
        ...
        "schedule" => print_help_lines(&[
            ...
            "",
            "output:",
            "  status prints node<TAB>kind<TAB>agent<TAB>child<TAB>session<TAB>model<TAB>life<TAB>state",
            "  claim/result print child status, backing agent/session/model/life/parent, and child ABI paths",

...
use crate::{
    JsonStringField, JsonlLineShape, for_each_jsonl_line, parse_jsonl_line, provider_native_fields,
};
...
pub(crate) fn inspect_message_stream_line(
    line_number: usize,
    line: &str,
...
pub(crate) fn append_provider_native_message_field_issues(
    line_number: usize,
    value: &Value,
    issues: &mut Vec<MessageStreamIssue>,
) {

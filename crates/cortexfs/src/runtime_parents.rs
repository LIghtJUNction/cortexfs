...
use crate::abi::{
    ...
    DEMO_THREAD_TOOL_LOOP_CONTROL_PATH, DEMO_THREAD_TOOL_LOOP_PATH,
    DEMO_THREAD_TOOL_LOOP_STATE_PATH, EXPORT_FILTERS_DIR_PATH, EXPORTS_DIR_PATH,
...
impl RuntimeParents {
    pub fn from_tree(tree: &StaticTree) -> Self {
        ...
        Self {
            ...
            exports: tree.path_inode(EXPORTS_DIR_PATH),
            ...
            collab_locks: tree.path_inode(&["spaces", "shared", "project-a", "collab", "locks"]),

...
const OPENAI_CHAT_SCHEMA: &str = r#"{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"properties":{"model":{"type":"string"},"messages":{"type":"array","items":{"type":"object","additionalProperties":true,"required":["role","content"],"properties":{"role":{"type":"string"},"content":{"oneOf":[{"type":"string"},{"type":"array","items":{"type":"object","additionalProperties":true}},{"type":"null"}]},"name":{"type":"string"},"tool_calls":{"type":"array","items":{"type":"object","additionalProperties":true}},"tool_call_id":{"type":"string"},"function_call":{"type":"object","additionalProperties":true},"audio":{"type":"object","additionalProperties":true},"refusal":{"type":["string","null"]}}}},"audio":{"type":"object","additionalProperties":true},"frequency_penalty":{"type":["number","null"]},"function_call":{"oneOf":[{"type":"string"},{"type":"object","additionalProperties":true}]},"functions":{"type":"array","items":{"type":"object","additionalProperties":true}},"logit_bias":{"type":["object","null"],"additionalProperties":{"type":"integer"}},"logprobs":{"type":["boolean","null"]},"max_completion_tokens":{"type":["integer","null"]},"max_tokens":{"type":["integer","null"]},"metadata":{"type":["object","null"],"additionalProperties":{"type":"string"}},"modalities":{"type":"array","items":{"type":"string"}},"moderation":{"type":["object","null"],"additionalProperties":true},"n":{"type":["integer","null"]},"parallel_tool_calls":{"type":"boolean"},"prediction":{"type":["object","null"],"additionalProperties":true},"presence_penalty":{"type":["number","null"]},"prompt_cache_key":{"type":"string"},"prompt_cache_retention":{"type":["string","null"]},"reasoning_effort":{"type":["string","null"]},"response_format":{"type":"object","additionalProperties":true},"safety_identifier":{"type":"string"},"seed":{"type":["integer","null"]},"service_tier":{"type":["string","null"]},"stop":{"oneOf":[{"type":"string"},{"type":"array","items":{"type":"string"}},{"type":"null"}]},"store":{"type":["boolean","null"]},"stream":{"type":["boolean","null"]},"stream_options":{"type":["object","null"],"additionalProperties":true},"temperature":{"type":["number","null"]},"tool_choice":{"oneOf":[{"type":"string"},{"type":"object","additionalProperties":true}]},"tools":{"type":"array","items":{"type":"object","additionalProperties":true}},"top_logprobs":{"type":["integer","null"]},"top_p":{"type":["number","null"]},"user":{"type":"string"},"verbosity":{"type":["string","null"]},"web_search_options":{"type":"object","additionalProperties":true}},"required":["messages"]}
"#;

const OPENAI_RESPONSES_SCHEMA: &str = r#"{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"properties":{"model":{"type":"string"},"input":{"oneOf":[{"type":"string"},{"type":"array","items":{"type":"object","additionalProperties":true}},{"type":"object","additionalProperties":true}]},"instructions":{"type":["string","null"]},"conversation":{"oneOf":[{"type":"string"},{"type":"object","additionalProperties":true},{"type":"null"}]},"previous_response_id":{"type":["string","null"]},"prompt":{"type":["object","null"],"additionalProperties":true},"tools":{"type":"array","items":{"type":"object","additionalProperties":true}},"tool_choice":{"oneOf":[{"type":"string"},{"type":"object","additionalProperties":true}]},"parallel_tool_calls":{"type":"boolean"},"max_tool_calls":{"type":"integer"},"max_output_tokens":{"type":["integer","null"]},"temperature":{"type":"number"},"top_p":{"type":"number"},"text":{"type":"object","additionalProperties":true,"properties":{"format":{"type":"object","additionalProperties":true},"verbosity":{"type":"string"}}},"reasoning":{"type":"object","additionalProperties":true,"properties":{"effort":{"type":"string"},"summary":{"type":"string"},"generate_summary":{"type":"string"}}},"metadata":{"type":"object","additionalProperties":{"type":"string"}},"include":{"type":"array","items":{"type":"string"}},"background":{"type":"boolean"},"store":{"type":"boolean"},"stream":{"type":"boolean"},"service_tier":{"type":"string"},"truncation":{"type":"string"},"user":{"type":"string"},"safety_identifier":{"type":"string"},"prompt_cache_key":{"type":"string"},"prompt_cache_retention":{"type":"string"},"frequency_penalty":{"type":"number"},"presence_penalty":{"type":"number"},"top_logprobs":{"type":"integer"}},"required":["input"]}
"#;

const ANTHROPIC_MESSAGES_SCHEMA: &str = r#"{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"properties":{"model":{"type":"string"},"max_tokens":{"type":"integer"},"messages":{"type":"array","items":{"type":"object","additionalProperties":true,"required":["role","content"],"properties":{"role":{"type":"string"},"content":{"oneOf":[{"type":"string"},{"type":"array","items":{"type":"object","additionalProperties":true}}]}}}},"system":{"oneOf":[{"type":"string"},{"type":"array","items":{"type":"object","additionalProperties":true}}]},"stream":{"type":"boolean"},"tools":{"type":"array","items":{"type":"object","additionalProperties":true}},"tool_choice":{"type":"object","additionalProperties":true},"thinking":{"type":"object","additionalProperties":true},"metadata":{"type":"object","additionalProperties":true},"stop_sequences":{"type":"array","items":{"type":"string"}},"service_tier":{"type":"string"},"container":{"type":["string","null"]},"cache_control":{"type":["object","null"],"additionalProperties":true},"output_config":{"type":"object","additionalProperties":true},"inference_geo":{"type":["string","null"]},"temperature":{"type":"number"},"top_k":{"type":"integer"},"top_p":{"type":"number"}},"required":["messages"]}
"#;

const GOOGLE_GENERATE_CONTENT_SCHEMA: &str = r#"{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"properties":{"model":{"type":"string"},"contents":{"type":"array","items":{"type":"object","additionalProperties":true,"properties":{"role":{"type":"string"},"parts":{"type":"array","items":{"type":"object","additionalProperties":true}}}}},"systemInstruction":{"oneOf":[{"type":"string"},{"type":"object","additionalProperties":true}]},"generationConfig":{"type":"object","additionalProperties":true,"properties":{"stopSequences":{"type":"array","items":{"type":"string"}},"responseMimeType":{"type":"string"},"responseSchema":{"type":"object","additionalProperties":true},"responseJsonSchema":{},"responseModalities":{"type":"array","items":{"type":"string"}},"candidateCount":{"type":"integer"},"maxOutputTokens":{"type":"integer"},"temperature":{"type":"number"},"topP":{"type":"number"},"topK":{"type":"integer"},"seed":{"type":"integer"},"speechConfig":{"type":"object","additionalProperties":true},"thinkingConfig":{"type":"object","additionalProperties":true},"imageConfig":{"type":"object","additionalProperties":true}}},"tools":{"type":"array","items":{"type":"object","additionalProperties":true}},"toolConfig":{"type":"object","additionalProperties":true},"safetySettings":{"type":"array","items":{"type":"object","additionalProperties":true}},"cachedContent":{"type":"string"},"serviceTier":{"type":"string"}},"required":["contents"]}
"#;

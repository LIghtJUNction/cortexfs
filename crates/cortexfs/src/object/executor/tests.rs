use super::{
    ...
    BWRAP_PROGRAM, ExecError, MAX_AGENT_MODEL_FRAME_BYTES, MAX_AGENT_MODEL_FRAMES,
    ...
    agent_tool_bwrap_args, agent_tool_call_from_value, agent_tool_timeout_seconds_from_env,
    collect_child_stderr, curl_config_quote, execute_agent_tool_call, first_tool_call,
    frames_have_error, is_passthrough_tool, is_regular_file_no_follow, missing_model_message,
    model_candidates, nested_control_environment, nested_control_socket_is_plain,

...
use super::{
    ...
    admit_provider_candidate, agent_continuation_messages, agent_model_command,
    agent_model_timeout_seconds_from_env, agent_tool_call_from_value,
    agent_tool_timeout_seconds_from_env, budget_from_effective, collect_child_stderr,

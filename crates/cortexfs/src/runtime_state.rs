...
pub struct RuntimeState {
    ...
    pub(crate) user_models_refresh_compat_inode: Option<Inode>,
    pub(crate) user_models_count_inode: Option<Inode>,
    pub(crate) user_models_count_compat_inode: Option<Inode>,
    pub(crate) user_models_list_inode: Option<Inode>,
    pub(crate) user_models_list_compat_inode: Option<Inode>,
    ...
    pub(crate) provider_models_refresh_compat: BTreeMap<&'static str, Inode>,

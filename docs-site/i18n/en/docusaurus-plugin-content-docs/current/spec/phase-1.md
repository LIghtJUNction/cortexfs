...
/ctx/agent/coder.d/{owner,uid,gid,groups,label,iso,parent,life,root,cwd,env,path,mount,model,abi,system.md,prompt.template.md,policy,status,pid,log,meta.json}
/ctx/tool/fs.read
/ctx/tool/fs.write
/ctx/tool/shell.exec

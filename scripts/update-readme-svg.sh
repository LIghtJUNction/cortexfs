...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="560" viewBox="0 0 1200 560" role="img" aria-labelledby="title desc">
  <title id="title">CortexFS: four agents, one Unix ABI</title>
  <desc id="desc">Four default agent roles share the frozen CortexFS Unix ABI, with the coder lifecycle moving from start to ready to chat.</desc>
  <defs>
    ...
    <filter id="shadow" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="20" stdDeviation="22" flood-color="#000" flood-opacity=".28"/></filter>
    <style>.serif{font-family:Georgia,"Times New Roman",serif}.sans{font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif}.mono{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}.paper{fill:#fffdfa}.muted{fill:#bfb6a8}.mint{fill:#64c8a9}.lime{fill:#d8ff66}.ink{fill:#111312}.soft{fill:#fffdfa;fill-opacity:.06;stroke:#fffdfa;stroke-opacity:.11}</style>
  </defs>
  ...
  <g transform="translate(64 164)">
    ...
    <text class="serif paper" x="0" y="72" font-size="62" font-weight="650">Four agents.</text>
  ...
  <g transform="translate(638 56)" filter="url(#shadow)">
    ...
    <g transform="translate(24 76)">
      ...
      <text class="sans mint" x="0" y="188" font-size="12" font-weight="900" letter-spacing="2">CODER LIFECYCLE</text>
      <line x1="56" y1="238" x2="396" y2="238" stroke="#8a948f" stroke-width="2"/>
      <circle cx="56" cy="238" r="17" fill="#fffdfa"/><circle cx="226" cy="238" r="17" fill="#2a8f73"/><circle cx="396" cy="238" r="17" fill="#d8ff66"/>
      <text class="mono paper" x="31" y="278" font-size="14" font-weight="850">start</text><text class="mono mint" x="200" y="278" font-size="14" font-weight="850">ready</text><text class="mono lime" x="376" y="278" font-size="14" font-weight="850">chat</text>
      <rect x="0" y="304" width="452" height="42" rx="6" fill="#d8ff66" fill-opacity=".08" stroke="#d8ff66" stroke-opacity=".2"/><text class="mono paper" x="16" y="330" font-size="13" font-weight="850">/ctx/agent/coder.sock  LISTEN</text>
    </g>
  </g>
</svg>
SVG
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800" role="img" aria-labelledby="title desc">
  ...
  <desc id="desc">The frozen /ctx root, the three executable object classes, object-local runtime state, and the four default agent roles.</desc>
...
SVG
        ...
        while IFS=$'\t' read -r label mean min max count; do
            ...
            y=$((174 + row * 54))
            barw=$(awk -v mean="$mean" -v max="$max_mean" 'BEGIN { w = 500 * mean / max; if (w < 3) w = 3; printf "%d", w }')

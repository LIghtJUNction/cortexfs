...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="520" viewBox="0 0 1200 520" role="img" aria-labelledby="title desc">
  <title id="title">/ctx</title>
  <desc id="desc">CortexFS path wordmark.</desc>
  <rect width="1200" height="520" fill="#BCD1CA"/>
  <path fill="#FAF9F5" d="M112 102c3-27 25-43 60-40l832 14c46 1 71 21 66 59l-12 252c-2 43-35 70-82 67L190 440c-54-2-80-28-75-69l14-143c3-29-23-48-17-126Z"/>
  <text x="380" y="341" fill="#141413" font-family="Avenir Next, Inter, ui-sans-serif, sans-serif" font-size="226" font-weight="700" letter-spacing="-20">/</text>
  <text x="464" y="336" fill="#D97757" font-family="Avenir Next, Inter, ui-sans-serif, sans-serif" font-size="205" font-weight="900" letter-spacing="-4">ctx</text>
</svg>
SVG
}
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="960" viewBox="0 0 1200 960" role="img" aria-labelledby="title desc">
  <title id="title">CortexFS ABI and durable session map</title>
  <desc id="desc">The frozen /ctx root, three executable object classes, three managed agents, and session durability: raw messages and events, rebuildable context, and archive-first garbage collection.</desc>
  ...
  <rect class="bg" width="1200" height="960"/><g transform="translate(58 50)"><text class="serif ink" x="0" y="0" font-size="42" font-weight="650">CortexFS ABI</text><text class="sans muted" x="0" y="36" font-size="19" font-weight="600">Frozen root, executable objects, durable sessions.</text></g>
  ...
  <g transform="translate(58 620)"><rect class="panel" width="1074" height="104" rx="8"/><text class="sans mint" x="20" y="28" font-size="12" font-weight="950" letter-spacing="2">THREE MANAGED AGENTS</text><g transform="translate(20 42)"><rect width="330" height="46" rx="6" fill="#181b19"/><text class="mono lime" x="14" y="29" font-size="14" font-weight="900">architect</text><text class="sans" x="130" y="29" font-size="12" font-weight="700" fill="#bfb6a8">plan + coordinate</text><rect x="352" width="330" height="46" rx="6" fill="#181b19"/><text class="mono lime" x="366" y="29" font-size="14" font-weight="900">executor</text><text class="sans" x="466" y="29" font-size="12" font-weight="700" fill="#bfb6a8">implement + verify</text><rect x="704" width="330" height="46" rx="6" fill="#181b19"/><text class="mono lime" x="718" y="29" font-size="14" font-weight="900">product-manager</text><text class="sans" x="868" y="29" font-size="12" font-weight="700" fill="#bfb6a8">scope + criteria</text></g></g>
